...
if IN_MODELSCOPE_SPACE:
    ...
    SENTENCE_TRANSFORMERS_CACHE_DIR = "/mnt/workspace/.cache/huggingface/sentence_transformers"
    ...
    print(f"[Config] SentenceTransformers 缓存: {SENTENCE_TRANSFORMERS_CACHE_DIR}")
